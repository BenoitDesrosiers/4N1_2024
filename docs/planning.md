Semaine 1 à 3, actuellement c'était du SQL. J'aurais gardé la semaine 1 pour expliquer SQL Server (type de données) pour qu'ils soient en mesure de créer la BD en sql.
